...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_enable',
        get_string('enabled', 'local_reminders'),
        get_string('enableddescription', 'local_reminders'),
        1
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_timezone',
    ...
    $settings->add(new admin_setting_configtext(
        'local_reminders_messagetitleprefix',
        get_string('messagetitleprefix', 'local_reminders'),
        get_string('messagetitleprefixdescription', 'local_reminders'),
        'Moodle-Reminder'
    ));
    ...
    $settings->add(new admin_setting_configselect(
        'local_reminders_sendas',
        get_string('sendas', 'local_reminders'),
        get_string('sendasdescription', 'local_reminders'),
        REMINDERS_SEND_AS_ADMIN,
        $replychoices
    ));

    $settings->add(new admin_setting_configtext(
        'local_reminders_sendasname',
        get_string('sendasnametitle', 'local_reminders'),
        get_string('sendasnamedescription', 'local_reminders'),
        'No Reply'
    ));
    ...
    $settings->add(new admin_setting_configmultiselect(
        'local_reminders_excludedmodulenames',
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_fallback_customsched',
        get_string('customschedulefallback', 'local_reminders'),
        get_string('customschedulefallbackdesc', 'local_reminders'),
        1
    ));
    ...
    $settings->add(new admin_setting_heading(
        'local_reminders_heading_emailcutomizations',
        get_string('emailconfigsheading', 'local_reminders'),
        ''
    ));

    $settings->add(new admin_setting_confightmleditor(
        'local_reminders_emailheadercustom',
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_emailfooterdefaultenabled',
        get_string('emailfooterdefaultname', 'local_reminders'),
        get_string('emailfooterdefaultnamedesc', 'local_reminders'),
        1
    ));

    $settings->add(new admin_setting_confightmleditor(
        'local_reminders_emailfootercustom',
    ...
    $settings->add(new admin_setting_heading(
        'local_reminders_heading_caleventchanged',
        get_string('caleventchangedheading', 'local_reminders'),
        get_string('caleventchangedheadingdetails', 'local_reminders')
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_enable_whenadded',
        get_string('enabledaddedevents', 'local_reminders'),
        get_string('enabledaddedeventsdescription', 'local_reminders'),
        0
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_enable_whenchanged',
        get_string('enabledchangedevents', 'local_reminders'),
        get_string('enabledchangedeventsdescription', 'local_reminders'),
        0
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_enable_whenremoved',
        get_string('enabledremovedevents', 'local_reminders'),
        get_string('enabledremovedeventsdescription', 'local_reminders'),
        0
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_enable_siteforcalevents',
        get_string('enabledforcalevents', 'local_reminders'),
        get_string('enabledforcaleventsdescription', 'local_reminders'),
        0
    ));
    ...
    $settings->add(new admin_setting_heading(
        'local_reminders_user_heading',
        get_string('userheading', 'local_reminders'),
        ''
    ));

    $settings->add(new admin_setting_configmulticheckbox2(
        'local_reminders_userrdays',
        get_string('reminderdaysahead', 'local_reminders'),
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_enable_userforcalevents',
        get_string('enabledforcalevents', 'local_reminders'),
        get_string('enabledforcaleventsdescription', 'local_reminders'),
        0
    ));
    ...
    $settings->add(new admin_setting_heading(
        'local_reminders_course_heading',
        get_string('courseheading', 'local_reminders'),
        ''
    ));

    $settings->add(new admin_setting_configmulticheckbox2(
        'local_reminders_courserdays',
        get_string('reminderdaysahead', 'local_reminders'),
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_noremindersforcompleted',
        get_string('activityignoreincompletes', 'local_reminders'),
        get_string('activityignoreincompletesdetails', 'local_reminders'),
        1
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_enableoverdueactivityreminders',
        get_string('overdueactivityreminders', 'local_reminders'),
        get_string('overdueactivityremindersdescription', 'local_reminders'),
        1
    ));

    $settings->add(new admin_setting_configtext(
        'local_reminders_overduewarnprefix',
        get_string('overduewarnprefix', 'local_reminders'),
        get_string('overduewarnprefixdescription', 'local_reminders'),
        'OVERDUE'
    ));

    $settings->add(new admin_setting_configtext(
        'local_reminders_overduewarnmessage',
        get_string('overduewarnmessage', 'local_reminders'),
        get_string('overduewarnmessagedescription', 'local_reminders'),
    ...
    $settings->add(new admin_setting_configselect(
        'local_reminders_duesend',
        get_string('sendactivityreminders', 'local_reminders'),
        get_string('explainsendactivityreminders', 'local_reminders'),
        REMINDERS_ACTIVITY_BOTH,
        $activitychoices
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_separateactivityopenings',
        get_string('activityopeningseparation', 'local_reminders'),
        get_string('activityopeningseparationdesc', 'local_reminders'),
        0
    ));

    $settings->add(new admin_setting_configmulticheckbox2(
        'local_reminders_dueopenrdays',
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_explicitenable',
        get_string('activityconfexplicitenable', 'local_reminders'),
        get_string('activityconfexplicitenabledesc', 'local_reminders'),
        0
    ));

    $settings->add(new admin_setting_configmulticheckbox2(
        'local_reminders_duerdays',
        get_string('reminderdaysahead', 'local_reminders'),
    ...
    $settings->add(new admin_setting_configmulticheckbox2(
        'local_reminders_activityroles',
        get_string('rolesallowedfor', 'local_reminders'),
        get_string('explainrolesallowedfor', 'local_reminders'),
        $defaultrolesforactivity,
        $rolesarray
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_enable_dueforcalevents',
        get_string('enabledforcalevents', 'local_reminders'),
        get_string('enabledforcaleventsdescription', 'local_reminders'),
        0
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_showmodnameintitle',
        get_string('showmodnameintitle', 'local_reminders'),
        get_string('showmodnameintitledesc', 'local_reminders'),
        1
    ));
    ...
    $settings->add(new admin_setting_heading(
        'local_reminders_group_heading',
        get_string('groupheading', 'local_reminders'),
        ''
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_groupshowname',
        get_string('groupshowname', 'local_reminders'),
        get_string('explaingroupshowname', 'local_reminders'),
        1
    ));

    $settings->add(new admin_setting_configmulticheckbox2(
        'local_reminders_grouprdays',
        get_string('reminderdaysahead', 'local_reminders'),
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_enable_groupforcalevents',
        get_string('enabledforcalevents', 'local_reminders'),
        get_string('enabledforcaleventsdescription', 'local_reminders'),
        0
    ));
    ...
    $settings->add(new admin_setting_heading(
        'local_reminders_category_heading',
        get_string('categoryheading', 'local_reminders'),
        ''
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_category_noforcompleted',
        get_string('categorynosendforended', 'local_reminders'),
        get_string('categorynosendforendeddescription', 'local_reminders'),
        1
    ));

    $settings->add(new admin_setting_configmulticheckbox2(
        'local_reminders_categoryrdays',
        get_string('reminderdaysahead', 'local_reminders'),
    ...
    $settings->add(new admin_setting_configduration(
        'local_reminders_categorycustom',
        get_string('reminderdaysaheadcustom', 'local_reminders'),
        get_string('reminderdaysaheadcustomdetails', 'local_reminders'),
        0
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_reminders_enable_categoryforcalevents',
        get_string('enabledforcalevents', 'local_reminders'),
        get_string('enabledforcaleventsdescription', 'local_reminders'),
        0
    ));
